...
namespace WinFormsDifferentialEquationsButcherExercise20point1_1Sep2024
{
    internal class ControlManager
    {
        ...
        public ControlManager(int width, int height)
        {
            ...
            double initial_y = 0.25;
            double C = 1.0 / initial_y; // 4 
            double y1_initial = y1_exact_function(0, C); // 0.25
