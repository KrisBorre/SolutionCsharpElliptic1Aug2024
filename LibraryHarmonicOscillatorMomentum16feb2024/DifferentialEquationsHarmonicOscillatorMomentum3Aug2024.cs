...
namespace LibraryHarmonicOscillatorMomentum16feb2024
{
    ...
    public class DifferentialEquationsHarmonicOscillatorMomentum3Aug2024<T> : DifferentialEquationsBaseClass26feb2024<T>
        where T : INumber<T>
    {
        private MassManager<T> mass_manager;
        private SpringManager<T> spring_manager;

        public DifferentialEquationsHarmonicOscillatorMomentum3Aug2024(ParameterConfiguration spring_configuration = ParameterConfiguration.Constant, ParameterConfiguration mass_configuration = ParameterConfiguration.Constant)
        {
