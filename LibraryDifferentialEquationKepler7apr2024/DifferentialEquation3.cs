...
namespace LibraryDifferentialEquationKepler7apr2024
{
        ...
        where T : INumber<T>
    {
        ...
        public DifferentialEquation3(MassExoplanetManager<T> mass_exoplanet_manager,
            MassStarManager<T> mass_star_manager,
        ...
        public override T function(T interval, T x, params T[] y)
        {
            ...
            return -(y[0] * mass * Mass) / T.CreateChecked(Math.Pow(temp1, 1.5));
        }
    }
}
