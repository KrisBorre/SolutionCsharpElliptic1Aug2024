...
namespace WinFormsCosSinCrude27Aug2024
{
    internal class ControlManager
    {
        ...
        public ControlManager(int width, int height)
        {
            ...
            */
            ...
            var cosSin = new DifferentialEquationsCosSin26Aug2024<double>();
            int numberOfFirstOrderEquations = cosSin.NumberOfFirstOrderEquations;
            ISolver26feb2024<double> solver1 = new DifferentialEquationsSolver26feb2024<double>(cosSin, Method.RK41 | Method.Sophisticated);
            ISolver26feb2024<double> solver2 = new DifferentialEquationsSolver26feb2024<double>(cosSin, Method.RK41 | Method.Crude);
