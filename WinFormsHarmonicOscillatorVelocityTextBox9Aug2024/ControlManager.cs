...
namespace WinFormsHarmonicOscillatorVelocityTextBox9Aug2024
{
    internal class ControlManager
    {
        ...
        public ControlManager(int width, int height)
        {
            ...
            this.label1.Text = "Solving a system of differential equations: Harmonic oscillator.";
        ...
        private void Calculate()
        {
            ...
            var problem = new DifferentialEquationsHarmonicOscillatorVelocity4Aug2024<double>(spring_configuration: spring_configuration, mass_configuration: mass_configuration);
        ...
        /// <summary>
        /// energy function using the displacement y1 and the velocity y2
        /// </summary>
        /// <param name="k">spring</param>
        /// <param name="m">mass</param>
        /// <param name="y1">displacement</param>
        /// <param name="y2">velocity</param>
        /// <returns></returns>
